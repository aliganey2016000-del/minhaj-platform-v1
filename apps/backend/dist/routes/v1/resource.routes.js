...
const ctrl = __importStar(require("../../controllers/resource.controller"));
const auth_middleware_1 = require("../../middleware/auth.middleware");
const role_middleware_1 = require("../../middleware/role.middleware");
const async_handler_middleware_1 = require("../../middleware/async-handler.middleware");
const router = (0, express_1.Router)();
router.use(auth_middleware_1.authMiddleware);
router.get('/my', (0, role_middleware_1.roleMiddleware)(['student']), (0, async_handler_middleware_1.asyncHandler)(ctrl.getMyDownloads));
router.get('/', role_middleware_1.adminOnly, (0, async_handler_middleware_1.asyncHandler)(ctrl.getAll));
