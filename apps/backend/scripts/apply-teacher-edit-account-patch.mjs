...
const alreadyPatched =
  text.includes('joiningDate, email, phone, password') &&
  text.includes(".populate('user', 'email phone isVerified isActive')");
...
// Keep previously patched deployments safe if this script runs again after the
// account update code has already been inserted by an earlier build.
text = text.replace(
