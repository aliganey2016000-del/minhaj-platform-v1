...
import { financialManager, financialOperator, financialRead } from '../../middleware/role.middleware';
...
router.post('/:id/close', financialManager, auditLoggingMiddleware(AUDITED_ACTIONS.CASH_SESSION_CLOSED, 'CashSession'), asyncHandler(controller.closeSession));
