...
import * as portalScheduleCtrl from '../../controllers/portal-class-schedule.controller';
...
router.get('/school/period-settings', roleMiddleware(['admin', 'org_admin', 'teacher', 'student']), asyncHandler(periodSettingsCtrl.getPeriodSettings));
...
router.get('/my', roleMiddleware(['student']), asyncHandler(portalScheduleCtrl.getMySchedules));
router.get('/my-teaching', roleMiddleware(['teacher']), asyncHandler(portalScheduleCtrl.getMyScheduleAsTeacher));
