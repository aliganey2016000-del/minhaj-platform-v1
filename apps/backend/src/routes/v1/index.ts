...
import whatsappAnalyticsRoutes from './whatsapp-analytics.routes';
...
router.use('/whatsapp/analytics', authMiddleware, requireModulePermission('communication'), whatsappAnalyticsRoutes);
