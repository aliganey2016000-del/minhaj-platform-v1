      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid gap-12 lg:grid-cols-[2fr_1fr_1fr_1fr]">
          <div className="space-y-6">
            <Link to="/" className="inline-flex items-center gap-3 rounded-3xl bg-white/[0.05] px-4 py-3 shadow-xl shadow-slate-950/20 ring-1 ring-white/10 transition hover:bg-white/[0.09]">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-gold-400 to-gold-500 text-emerald-950 shadow-lg shadow-gold-500/25">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a href="#" aria-label={t('footer.social_linkedin')} className="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-white/[0.05] text-emerald-50/80 transition hover:bg-gold-400/15">
              ...
              <a href="#" aria-label={t('footer.social_github')} className="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-white/[0.05] text-emerald-50/80 transition hover:bg-gold-400/15">
          ...
          <div className="space-y-5">
            <h3 className="text-sm font-semibold uppercase tracking-[0.24em] text-emerald-50/65">{t('footer.column_explore')}</h3>
          ...
          <div className="space-y-5">
            <h3 className="text-sm font-semibold uppercase tracking-[0.24em] text-emerald-50/65">{t('footer.column_contact')}</h3>
            <div className="space-y-3 text-sm text-emerald-50/55">
              <a href="mailto:invo@sahaledu.com" className="flex items-center gap-2 transition-colors hover:text-white">
                <span className="text-emerald-50/65">📧</span>
                invo@sahaledu.com
              </a>
              ...
              <div className="flex items-center gap-2 text-emerald-50/55">
                <span className="text-emerald-50/65">📍</span>
                {t('footer.address')}
              </div>
            </div>
        ...
        <div className="mt-14 border-t border-white/10 pt-8 sm:flex sm:items-center sm:justify-between">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-4 text-sm text-emerald-50/40 sm:mt-0">
