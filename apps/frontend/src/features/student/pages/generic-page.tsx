...
const pageTitles: Record<string, { title: string; icon: string; desc: string }> = {
  ...
  '/student/exams/seating':    { title: 'Seat & Hall Allocation', icon: '🪑', desc: 'Your designated room, desk number, and instructions — coming soon' },
  '/student/exams/active':     { title: 'Active Exams',           icon: '⏱️', desc: 'Launch and take your timed computer-based exams — coming soon' },
  '/student/exams/attendance': { title: 'Attendance History',     icon: '✅', desc: 'Your verified attendance records for past exams — coming soon' },
