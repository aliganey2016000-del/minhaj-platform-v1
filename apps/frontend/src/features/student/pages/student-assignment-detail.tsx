 ...
 *
 * Two-column layout:
 *   Left (70%): Assignment title, rich description, teacher materials
 *   Right (30%): Submission controls (answer textarea, file upload, submit button)
 */
  ...
  return (
    <div className="py-6 lg:py-10 relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* ── RIGHT COLUMN (1/3) — Submission Panel ── */}
        <div className="lg:col-span-1">
          <div className="sticky top-24 bg-[var(--color-surface-primary)] rounded-2xl border border-[var(--color-border-default)] p-6 shadow-card space-y-5">
            ...
            {success ? (
              ...
              <>
                ...
                <div>
                  ...
                  <textarea
                    className="w-full rounded-xl border border-[var(--color-border-default)] bg-[var(--color-surface-primary)] px-4 py-3 text-sm min-h-[160px] resize-y"
                ...
                <div>
                  ...
                  {uploadedUrl ? (
                    ...
                    <label
                      className={`flex flex-col items-center justify-center w-full rounded-xl border-2 border-dashed transition-colors cursor-pointer p-4 ${uploading ? 'border-primary-400 bg-primary-50 dark:bg-primary-950/20 pointer-events-none opacity-60' : 'border-[var(--color-border-default)] hover:border-emerald-400 hover:bg-[var(--color-surface-tertiary)]'}`}
                ...
                {/* Error */}
                {submitError && (
                  <p className="text-xs text-red-500 bg-red-50 dark:bg-red-950/30 rounded-lg px-3 py-2">{submitError}</p>
                )}
                ...
                <button
                  ...
                  className="w-full rounded-xl bg-emerald-600 px-4 py-3 text-sm font-semibold text-white hover:bg-emerald-700 active:bg-emerald-800 disabled:opacity-60 transition-all shadow-md shadow-emerald-600/20"
                >
                  {submitting
