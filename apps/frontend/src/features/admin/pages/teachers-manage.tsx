...
function TeacherRowActions({ teacher, onView, onEdit, onAssign, onStatus }: {
  teacher: Teacher;
  onView: () => void;
  onEdit: () => void;
  onAssign: () => void;
