...
import InstitutionStructureManage from './institution-structure-manage';

const cards = [
  { title: 'Staff Directory', description: 'Create, edit, import and manage staff accounts.', to: '/admin/staff', icon: UserRound },
  { title: 'Staff Attendance', description: 'Mark daily staff attendance and review history.', to: '/admin/hr?tab=attendance', icon: UsersRound },
  { title: 'Access & Permissions', description: 'Control staff portal access and page actions.', to: '/admin/hr/access', icon: ShieldCheck },
];
...
export function HrManagement() {
  ...
  if (searchParams.get('tab') === 'structure') return <InstitutionStructureManage />;
      ...
      <div className="rounded-2xl border border-[var(--color-border-default)] bg-[var(--color-surface-primary)] p-6 shadow-sm">
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 text-sm text-[var(--color-text-secondary)]">Manage your workforce, staff attendance and access from one place.</p>
