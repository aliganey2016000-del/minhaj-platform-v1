...
function InstitutionStructure() {
  ...
  return <div className="space-y-6 p-4 sm:p-6">
    ...
    <div className={`grid gap-6 ${isUniversity ? 'lg:grid-cols-2' : ''}`}>
      {isUniversity && <section className="rounded-2xl border border-[var(--color-border-default)] bg-[var(--color-surface-primary)] p-5 shadow-sm">
      ...
      <section className="rounded-2xl border border-[var(--color-border-default)] bg-[var(--color-surface-primary)] p-5 shadow-sm">
